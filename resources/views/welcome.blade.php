		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item"><a href="event.html" class="nav-link">Acara</a></li>
					<li class="nav-item"><a href="sponsors.html" class="nav-link">Sponsor</a></li>
			...
			<div class="row d-flex flex-row justify-content-center align-contents-center">
				<div class="col-md-3 d-flex align-self-stretch ftco-animate">
					<div class="media block-6 services d-block">
						<div class="icon text-center"><span class="flaticon-placeholder"></span></div>
