    ...
    <section class="hero-wrap hero-wrap-2 js-fullheight" style="background-image: url('images/bg_1.png');" data-stellar-background-ratio="0.5">
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
          <div class="col-md-9 ftco-animate pb-5">
            ...
            <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Beranda <img src="/images/arrow.svg"></i></a></span> <span>Kontak <img src="/images/arrow.svg"></i></span></p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row d-flex mb-5 contact-info">
          ...
          <div class="w-100"></div>
          <div class="col-md-3">
            <p><span>Alamat:</span> Jakarta, Indonesia</p>
          </div>
          <div class="col-md-3">
            <p><span>Email:</span> <a href="mailto:aruteknologi@gmail.com">aruteknologi@gmail.com</a></p>
          </div>
          <div class="col-md-3">
            <p><span>Website:</span> <a href="http://www.aruteknologi.com/">aruteknologi.com</a></p>
          </div>
        </div>
  ...
  <div class="form-group">
    <button type="submit" class="btn btn-primary py-3 px-5">Kirim Pesan</button>
          ...
          <div class="col-md-6 d-flex">
            <img src="/images/kontak.gif" alt="Deskripsi gambar" class="img-fluid" /> 
          </div>
        </div>
      </div>
    </section>
				...
				<div class="col-md">
					<div class="ftco-footer-widget mb-4">
						...
						<div class="block-23 mb-3">
							...
							<li><img src="/images/whatsapp.png" width="20" height="20" class="icon-image" style="margin-right: 22px;"><span class="text">+62 8953-845-34608</span></li>
